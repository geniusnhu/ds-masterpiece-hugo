...
One year ago, when I truly seriously considered improve my skill in Data Science, a question was always lingering in my mind:

**What truly are the skills that a Data Scientist needs?**

**How do I improve myself in the right direction at the most efficacy?**
...
Therefore, when I was known of the Kaggle dataset on Survey of Data Science and Machine learning, this data will definitely give me some insights for my questions.

The Data source is [here](https://www.kaggle.com/c/kaggle-survey-2019) 

In this blog, I will summary my findings as summary profile describing a Data Scientist. The complete analysis can be found through this [link](https://www.kaggle.com/geninhu/direction-toward-a-great-data-scientist/data)
...
![](/2020-01-17-quick-deep-dive-at-data-scientist-skill-set/index_files/responsibility.png)
...
![](/2020-01-17-quick-deep-dive-at-data-scientist-skill-set/index_files/PL.png)
...
4. Machine Learning algorithm skills:
...
![](/2020-01-17-quick-deep-dive-at-data-scientist-skill-set/index_files/ML.png)
...
![](/2020-01-17-quick-deep-dive-at-data-scientist-skill-set/index_files/package.png)

6. Data Scientist Credential:
...
* Familiar with and expert in Python, SQL and/or R

* Fluency in using Local development environments and Intergrated development Environment, including but not limited to Jupyter, RStudio, Pycharm

* Strong foundation with practical experience in Linear/Logistics regression, Decision Tree/Random Forest, and Gradient Boosting models. Moreover, besides popular and must known libraries such as Scikit-learn, Keras, Tensorflow, Xgboost is the framework that student should learn at the moment.
